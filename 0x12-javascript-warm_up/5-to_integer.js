#!/usr/bin/node
// We using the isNaN() function to check if the first argument (arg) can be converted to an int.

const arg = process.argv[2];

// using the ! operator to invert the boolean value returned by isNaN()
